...
author: "Le Song Perm: 9746488 Zhongyun Zhang Perm: 5559158"
date: "12/10/2020"
output:
...
#Problem1 What makes voter behavior prediction (and thus election forecasting) a hard problem?
voter behavior prediction is a hard problem because:

Firstly, people are voting based on many inner factors contribute to the voter behavior, for example, race, gender, age, income, etc. Also, their decisions may varies due to media, political propaganda, family and friends, etc.Thus,it is difficult to create an efficient, accurate sampling model.
...
#Problem2 What was unique to Nate Silver's approach in 2012 that allowed him to achieve good predictions?
...
#Problem3 What went wrong in 2016? What do you think should be done to make future predictions better?
...
ct.pc<-pc1$x[,1:2]
pc2 <- prcomp(census.subct[,4:29], scale = TRUE, center = TRUE) 
subct.pc<-pc2$x[,1:2]
#biplot(pc1, scale = 0)
#biplot(pc2, scale = 0)
...
title("Desision Tree Before Pruned")
